...
public class PmsProductAttributeController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "type", value = "0表示屬性，1表示參數", required = true, paramType = "query", dataType = "integer")})
    ...
    @ApiOperation("根據商品分類的id獲取商品屬性及屬性分類")
